...
export const metadata: Metadata = {
  ...
  description:
    'Get in touch with the FRAM.DEV team for your web development projects and inquiries',
  alternates: {
      ...
      <main className="container mx-auto px-4 py-16">
        <div className="mx-auto max-w-6xl">
          ...
          <p className="mx-auto mb-16 max-w-2xl text-center text-lg text-gray-600 dark:text-gray-300">
            Have a project in mind or a question about our services? We&apos;d love to hear from
            you! Fill out the form below, and our team will get back to you as soon as possible.
          </p>
          ...
          <div className="mt-20 grid grid-cols-1 gap-12 md:grid-cols-3">
            ...
            <div className="rounded-lg bg-white p-6 text-center shadow-md dark:bg-gray-800">
              ...
              <p className="text-gray-600 dark:text-gray-300">
                Remote team with headquarters in Warsaw, Poland
              </p>
            </div>
          </div>
        </div>
