        ...
        <div className="flex h-14 items-center justify-between sm:h-16">
          ...
          <Link href="/" className="flex items-center">
            <Image
              ...
              width={30}
              height={30}
              className={`size-8 transition-all duration-300 sm:size-10 md:size-12 lg:size-14`}
            />
            <span
            ...
            <div className="flex min-h-screen flex-col">
                    ...
                    >
                      {link.name === 'Kontakt' ? (
                        ...
                        <>
                          <Link
                            href={link.href}
                            className="block px-4 py-2 text-3xl font-bold text-gray-800 transition-colors duration-300 hover:text-primary sm:text-4xl"
                            onClick={() => setMobileMenuOpen(false)}
                          >
                            {link.name}
                          </Link>
              ...
              <div className="border-t border-gray-100 px-6 py-8">
                <div className="flex flex-col items-center space-y-6">
                  <h3 className="text-lg font-medium text-gray-500">Połącz się z nami</h3>
